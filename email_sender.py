...
def render_fp1_penalty_email(language: str, selected_vars: list, values: dict) -> dict:
    ...
    fn_hi = t['fundamental_number']['hi']
    fn_en = t['fundamental_number']['en']
    ft_hi = t['fundamental_title']['hi']
    ft_en = t['fundamental_title']['en']
    case_reason_hi = "एक एक्टिव Wiom कनेक्शन को Wiom के बाहर इंटरनेट सेवा ऑफर या प्रमोट की गई।"
    case_reason_en = "A non-Wiom internet service was offered or promoted to an active Wiom connection."

    if language == "hi":
        subject = f"महत्वपूर्ण: Wiom {fn_hi} के अंतर्गत सिस्टम परिणाम लागू"
        proof = proof_fn("hi")
        body = f"""WIOM सिस्टम नोटिस।

System records indicate a violation related to Wiom {fn_en} — {ft_en}.
...
इस स्थिति के आधार पर ₹2000 की Recovery लागू की गई है।

यदि आपको यह जानकारी गलत लगती है, तो 48 घंटे के भीतर 7836811111 पर कॉल करें। उपलब्ध रिकॉर्ड के आधार पर पुनः समीक्षा की जाएगी।

अधिक जानकारी के लिए Partner App में "Wiom Partner System Fundamentals" सेक्शन देखें।
https://partnerapp.wiom.in/wiom-agreement

यह सूचना सिस्टम द्वारा स्वचालित रूप से जारी की गई है।"""

    elif language == "en":
        subject = f"Important: System consequence applied under Wiom {fn_en}"
        proof = proof_fn("en")
        body = f"""WIOM System Notice.
...
Based on this state, a recovery of Rs. 2000 has been applied. If you believe this is incorrect, call 7836811111 within 48 hours. Available records will be reviewed.

For official details, refer to the "Wiom Partner System Fundamentals" section in the Partner App:
https://partnerapp.wiom.in/wiom-agreement

This communication is system-generated."""

    else:  # both
        subject = f"महत्वपूर्ण: Wiom {fn_hi} के अंतर्गत सिस्टम परिणाम लागू / Important: System consequence applied under Wiom {fn_en}"
